    ...
    <div class="bg_video">
        ...
        <div class="content_bg">
            <div class="content_inner">
                <h1>RLIXIR OIL SERUM</h1>
                <p>Với tinh chất Pitera – được chiết xuất từ sự thủy phân hoá đậu nành và protein từ men nấm – chứa nhiều vitamin, axit amino và các axit hữu cơ khác sẽ giải quyết được tình trạng lão hóa của làn da. </p>
